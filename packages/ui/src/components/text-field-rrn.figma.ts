// url=https://www.figma.com/design/spWdVkr7RbwWOyDG6xbY4z?node-id=2230-36204
// source=https://github.com/lupinesong2/UDS-repository/blob/main/packages/ui/src/components/text-field.tsx
// component=TextField

import figma from "figma"

// "[Text Field] RRN" (2230:36204) → <TextField variant="rrn"> (주민번호).
...
export default {
  ...
  example: figma.code`<TextField variant="rrn"${figma.helpers.react.renderProp("label", hasLabel ? "레이블" : undefined)} required${figma.helpers.react.renderProp("disabled", disabled)}${figma.helpers.react.renderProp("error", error)}${figma.helpers.react.renderProp("messages", hasSupporting ? ["도움말 메세지"] : undefined)} />`,
