...
export function EyeOffIcon(props: IconProps) {
  return (
    <SvgIcon {...props}>
      <path
        d="M4 4l16 16M9.9 5.2A9.5 9.5 0 0 1 12 5c6.5 0 10 7 10 7a15.9 15.9 0 0 1-3.3 3.9M6.3 8.1A15.9 15.9 0 0 0 2 12s3.5 7 10 7a9.5 9.5 0 0 0 3.1-.5M9.9 9.9a3 3 0 0 0 4.2 4.2"
        fill="none"
        stroke="currentColor"
        strokeWidth={2}
        strokeLinecap="round"
